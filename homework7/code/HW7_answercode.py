...
outputpath = r'C:\Users\dbrewer30\Dropbox\teaching\Courses\BrewerPhDEnv\Homeworks\phdee-2021-answers\homework7\output'
...
hw7output3 = pd.concat([outputa,outputb,outputc],axis = 1)
hw7output3.columns = ['(a)','(b)','(c)']
hw7output3.index = ['Sedan',' ','MPG','','Constant','']
hw7output3 = hw7output3.append(pd.DataFrame([[str(nobsa),str(nobsb),str(nobsc)], [fstata,fstatb,fstatc]], index = ['Observations', 'First stage F'], columns = ['(a)', '(b)','(c)']))

os.chdir(outputpath)
hw7output3.to_latex('hw7output3.tex',column_format = 'lccc', na_rep = ' ')
